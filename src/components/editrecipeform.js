        ...
        <div>
              <div className="row recipeHeader">
                ...
                <div className="col home-button">
                    <Link className="btn mx-1 btn-sm float-right btn-info" to={recipelink}>
                ...
                <div className="p-1">
                    <div className='row'>
                        <div className="col-sm-12 col-md-6 col-lg-3 form-group">
                            ...
                            <input type="text" className="form-control" name="recipelabel" defaultValue={this.props.label} disabled ref={this.label}/>
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-3 form-group">
                            <label htmlFor="Difficulty">Difficulty{aterisk}</label>
                            <select defaultValue={this.props.difficulty} className="custom-select" name='Difficulty'ref={this.difficulty} >
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-3 form-group">
                            ...
                            <select defaultValue={this.props.cost} className="custom-select" name='Cost'ref={this.cost} >
                                <option defaultValue>select one</option>
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-3 form-group">
                            ...
                            <select defaultValue={this.props.onepotmeal} className="custom-select" name='onepotmeal' ref={this.onepotmeal}>
                                <option defaultValue>select one</option>
                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-12 col-lg-6 form-group">
                            ...
                            <input defaultValue={this.props.tastetexture} type="text" className="form-control" placeholder='buttery, salty, sweet' name="taste" ref={this.tastetexture} />
                        </div>
                        <div className="col-sm-12 col-md-12 col-lg-6 form-group">
                            <label htmlFor="Occasion">Occasion{aterisk}</label>
                            <input defaultValue={this.props.occasion} type="text" className="form-control" name="Occasion" placeholder='Casual Dinner Party, Cooking for a date, game day' ref={this.occasion} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-sm-12 col-md-12 col-lg-6 form-group">
                            <label htmlFor="Meal">Meal{aterisk}</label>
                            <select defaultValue={this.props.meal} className="custom-select" name='Meal'ref={this.meal} >
                                <option defaultValue>select one</option>
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-6 form-group">
                            ...
                            <input defaultValue={this.props.timetaken} type="text" className="form-control" name="timetaken" placeholder='1 hour' ref={this.timetaken} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-sm-12 col-md-12 col-lg-6 form-group">
                            <label htmlFor="ingredients">ingredients{aterisk}</label>
                            <textarea defaultValue={this.props.ingredslist} type="text" className="form-control"
                                placeholder="include hyphen (-) between each ingredient. (example: Tomatos 5, Potatoes 2, Garam Masala ...)"
                                name="ingredients" row="3" ref={this.ingredients}></textarea>
                        </div>
                        <div className="col-sm-12 col-md-12 col-lg-6 form-group">
                            ...
                            <textarea type="text"
                                ...
                                className="form-control" name="instructions" row="3"ref={this.stepslist} ></textarea>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-sm-12 col-md-6 col-lg-3 form-group">
                            ...
                            <input defaultValue={this.props.image} type="text" className="form-control" name="image" ref={this.image} />
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-3 form-group">
                            <label htmlFor="calories">Calories{aterisk}</label>
                            <input defaultValue={this.props.calories} type="text" className="form-control" name="calories" ref={this.calories} />
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-3 form-group">
                            <label htmlFor="serves">Serves{aterisk}</label>
                            <input type="text" defaultValue={this.props.serves} className="form-control" name="serves" ref={this.serves} />
                        </div>
                    <div className="col-sm-12 col-md-6 col-lg-3 form-group">
                        <label htmlFor="publisher">Publisher Name{aterisk}</label>
                        <input type="text" defaultValue={this.props.publisher} className="form-control" name="publisher" disabled  ref={this.publisher}/>           
                    </div>            
                    </div>
                </div>
